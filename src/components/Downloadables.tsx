...
const downloadablesList: DownloadableItem[] = [
  {
    ...
    description: "An extensive curated guide exploring Spanish colonial ancestral homes across Poblacion I and II, the Sandugo covenant monument of National Artist Napoleon Abueva, and centuries old local narratives.",
    category: "Guides",
    fileSize: "4.8 MB",
    fileType: "PDF",
    downloadsCount: 1248,
...
-----------------------
1. Spanish Era Colonial Ancestral Houses (Poblacion I and II)
...
Support the Tagbilaran UNESCO Creative Cities Network Campaign!`
  },
  {
    ...
    title: "Sikatuna Transit and Walking Map",
...
-----------------------------
Route 1: The Historical Core (Poblacion I and II)
...
Route 2: The Artisan and Nature Trail (Northern Districts)
...
Please travel sustainably and respect traditional local landmarks!`
  ...
  {
    id: "wallpapers-pack",
    title: "Sandugo and Heritage Wallpaper Pack",
